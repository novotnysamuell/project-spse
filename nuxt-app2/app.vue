<template>
    <main>
      ...
      <section class="list">
        ...
        v-bind:class="{'card-container':true,'card':true,'adult':person.age>=18 }"><!--v tomto prípade clase priradíme objekt, ktorého vlastnosti predstavujú jednotlivé triedy a ich hodnoti predstavujú bool vyjadrujúci, kedy sa má daná trieda pridať danému elemntu-->
